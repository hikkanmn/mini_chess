//функция загрузки фигурок для шахмат
...
function coloring() {
    ...
    color.forEach(color => {
        ...
        if (a % 2 == 0) {
            color.style.backgroundColor = 'rgb(246, 237, 228)'
        }
        if (a % 2 !== 0) {
            color.style.backgroundColor = 'rgb(239, 182, 181)'
        }
    })
}
coloring()
...
// запрет на ход несколькми пешками одновременно
z = 0
